...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FND-001 | Fork baseline, program ledgers, evidence structure | blocked | coordinator | coordinator worktree (no branch) | none | `docs/modernization/{README,STATUS,STATUS_ARCHIVE,WORK_PACKAGES,DECISIONS,RISK_REGISTER,BASELINE,ROLLBACK}.md`, `docs/modernization/evidence/FND-001/**`, `scripts/modernization/**` | independent verifier | `evidence/FND-001/` | 2026-08-22 |
| FND-002 | API/Socket.IO contract inventory and golden fixtures | planned | unassigned | blocked on checkpoint (RISK-005) | FND-001 | `docs/modernization/API_CONTRACT_INVENTORY.md`, `scripts/modernization/{inventory-api,capture-fixtures}.mjs`, `server/tests/contract-fixtures/**`, `evidence/FND-002/**` | — | — | 2026-08-22 |
| FND-003 | Minimal TypeScript-to-ESM build boundary proof | planned | unassigned | blocked on checkpoint (RISK-005) | FND-001 | `server/modern-src/proof.ts`, `server/tests/modernBuild.test.js`, `tsconfig.modern.json`, `scripts/build-modern.mjs`, coordinator-owned package scripts/lockfile, `evidence/FND-003/**` | — | — | 2026-08-22 |
| DB-001 | Data model ADR and normalization mapping | planned | unassigned | blocked on checkpoint (RISK-005) | FND-001 | `docs/modernization/{DATA_MAPPING,ADR-DB-001}.md`, `server/tests/fixtures/modernization/**`, `evidence/DB-001/**` | — | — | 2026-08-22 |
...
**Nothing may move to `active` yet.** FND-002, FND-003, and DB-001 are the three packages the plan
