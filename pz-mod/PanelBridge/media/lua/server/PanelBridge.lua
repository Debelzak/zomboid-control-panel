...
-- Teleport a player (Handled by panel via RCON)
handlers.teleportPlayer = function(args)
    return false, nil, "Player teleportation is handled by the panel through RCON"
end

handlers.teleportTo = function(args)
    return false, nil, "Player teleportation is handled by the panel through RCON"
end
