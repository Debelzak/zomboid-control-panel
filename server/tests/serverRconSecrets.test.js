...
// getDataPaths() to its own mkdtempSync temp dir and tears it down with
// fs.rmSync in afterEach -- the shape modThumbnailResolution.test.js's
// ENOTEMPTY race needed (5d5a9088). This file's target (serverRconSecrets.js,
// which only imports uiSecretFile.js beyond fs/path/paths.js) never imports
// utils/logger.js transitively, so it was never actually at risk from this
// mechanism -- mock added anyway, cheap and matches the convention.
