...
// path, separate from every per-test mkdtempSync root this file actually
// deletes (see `temporaryDirectories` below) -- afterEach never rmSyncs
// this file's own "/logs" directory, so this file was never at risk from
...
// this suite, and removes the real winston logger's file writes from this
// test run entirely rather than relying on the two directories staying
// separate forever.
